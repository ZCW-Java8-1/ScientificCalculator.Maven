...
public class DisplayWork {
    ...
    public void calcRun() {
        ...
        while (onButton != false) {
            ...
            System.out.println("For the square, square-root, switch sign, fac, please enter one of these as the operator (square) ** */ (squareRoot) +/-(switch sign) fac (factorial)");
            System.out.println("For the inverse sine cosine tan invsine incosine invtangent, please type one of the respective operators.");
